...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-10 h-[64px] Laptop:h-20 ${pathname === ROUTES.DETAIL ? (hasScrolledPast ? "bg-BG" : "bg-transparent") : "bg-BG"} ${pathname === ROUTES.MY.default && "border-b border-D2_Gray"} `}
    >
