...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 h-[64px] Laptop:h-20 ${pathname === ROUTES.DETAIL ? (hasScrolledPast ? "bg-BG" : "bg-BG Laptop:bg-transparent") : "bg-BG"} ${pathname === ROUTES.MY && "border border-D2_Gray"} `}
    >
