...
export default function TabletMovieTop() {
  return (
    <div className="hidden w-full gap-4 Tablet:flex Laptop:hidden">
      <div className="h-[344px] w-[230px] flex-shrink-0  animate-pulse rounded-xl bg-D2_Gray"></div>
      <div className="flex w-full  flex-grow flex-col justify-between pt-3">
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <div className="mx-auto h-[30px] w-[30px] animate-pulse rounded-full bg-D3_Gray" />
