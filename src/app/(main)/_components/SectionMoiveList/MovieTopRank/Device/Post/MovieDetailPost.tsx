  ...
  return (
    <div className="relative w-full">
      <div
        ...
        } relative flex h-full flex-col justify-between gap-3 Laptop:gap-0 Laptop:transition-opacity Laptop:duration-700 Laptop:ease-in`}
      >
        <div className="relative flex flex-col gap-2 Laptop:gap-3">
        ...
        <div className="relative flex flex-col  Desktop:w-[504px]">
