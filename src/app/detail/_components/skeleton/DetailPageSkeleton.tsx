    ...
    <div className="absolute top-0 w-full">
      <div className="relative mx-[-20px] h-[380px] bg-D1_Gray Tablet:mx-[-24px] Laptop:hidden">
        <div className="absolute bottom-[-10px] left-1/2 flex -translate-x-1/2 flex-col items-center gap-2">
          <div className="h-[32px] w-[100px] rounded-lg bg-D2_Gray" />
          <div className="h-[20px] w-[140px] rounded-lg bg-D2_Gray" />
          <div className="h-[20px] w-[240px] rounded-lg bg-D2_Gray" />
        </div>
      </div>
      ...
      <div className="min-w-screen relative hidden bg-D1_Gray Laptop:block Laptop:h-[640px] Desktop:h-[816px]">
        <div className="absolute bottom-5 left-1/2 flex -translate-x-1/2 justify-between Laptop:w-[calc(100%-136px)] Desktop:w-[1560px]">
          <div className="mt-auto flex flex-col gap-3">
            <div className="h-10 w-[200px] rounded-lg bg-D2_Gray" />
            <div className="h-10 w-[400px] rounded-lg bg-D2_Gray" />
          </div>
          <div className="h-[258px] w-[172px] rounded-xl bg-D2_Gray Desktop:h-[360px] Desktop:w-[240px]" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="Laptop:hidden">
      <div className="mx-auto flex justify-center gap-10">
        <div className="h-[50px] w-[50px] rounded-lg bg-D2_Gray" />
        <div className="h-[50px] w-[50px] rounded-lg bg-D2_Gray" />
        <div className="h-[50px] w-[50px] rounded-lg bg-D2_Gray" />
      </div>

      <div className="mt-5 h-12 w-full rounded-xl bg-D2_Gray" />
      <div className="mt-4 flex h-[114px] w-full flex-col gap-2 rounded-xl bg-D1_Gray px-4 pt-5">
        <div className="h-5 w-full rounded-lg bg-D2_Gray" />
        <div className="h-5 w-[160px] rounded-lg bg-D2_Gray Tablet:w-[350px]" />
      </div>

      <div className="mx-auto mt-7 h-10 w-[180px] rounded-[30px] bg-D2_Gray" />

      <div className="mx-auto mt-[52px] Tablet:mt-[102px]">
        <div className="flex justify-center gap-2">
          <div className="h-[32px] w-20 rounded-lg bg-D2_Gray" />
          <div className="h-[32px] w-20 rounded-lg bg-D2_Gray" />
          <div className="h-[32px] w-20 rounded-lg bg-D2_Gray" />
        </div>
...
function PCContentsSkeleton() {
  return (
    <div className="hidden w-full Laptop:block">
      <div className="w-full rounded-[20px] bg-D2_Gray Laptop:h-[74px] Desktop:h-20" />
      <div className="mt-[52px] flex flex-col gap-[100px]">
        <div className="flex Laptop:gap-5 Desktop:gap-6">
          <div className="h-[256px] w-full rounded-xl bg-D1_Gray px-8 pt-7">
            <div className="h-5 w-full rounded-lg bg-D2_Gray" />
            <div className="mt-4 h-5 w-[350px] rounded-lg bg-D2_Gray" />
          </div>

          <div className="h-[256px] w-full">
            <div className="h-10 w-[140px] rounded-lg bg-D2_Gray" />
            <div className="mt-5 flex gap-4">
              {Array(8)
                ...
                .map((_, i) => (
                  ...
                  >
                    <div className="h-[112px] w-full rounded-lg bg-D2_Gray" />

                    <div className="mt-1 flex h-[60px] w-full flex-col items-center justify-center px-2 pt-2">
                      <div className="h-4 w-full rounded-[4px] bg-D2_Gray" />
                      <div className="mt-2 h-4 min-w-[calc(100%-16px)] rounded-[4px] bg-D2_Gray" />
                    </div>
                  </div>
                ))}
            </div>
          ...
          <div className="mt-5 flex Laptop:gap-5 Desktop:gap-6">
            {Array(4)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="w-full rounded-xl bg-D2_Gray Laptop:h-[150px] Desktop:h-[210px]"
                />
              ))}
          </div>
        </div>
        ...
        <div className="flex Laptop:gap-7 Desktop:gap-9">
          <div className="flex w-full flex-col items-center gap-6 rounded-xl">
            <div className="flex w-full flex-col items-center gap-6 rounded-xl bg-D1_Gray Laptop:py-8 Desktop:py-7">
              <div className="h-10 w-[140px] rounded-lg bg-D2_Gray" />
              <div className="h-10 w-[240px] rounded-lg bg-D2_Gray" />
            </div>
                ...
                .map((_, i) => (
                  ...
                  >
                    <div className="flex h-10 items-center gap-4">
                      <div className="h-10 w-10 rounded-full bg-D2_Gray" />
                      <div className="h-5 w-[120px] rounded-lg bg-D2_Gray" />
                    </div>

                    <div className="ml-[56px] mt-2">
                      <div className="h-5 w-full rounded-lg bg-D2_Gray" />
                      <div className="mt-2 h-5 w-[400px] rounded-lg bg-D2_Gray" />
                    </div>

                    <div className="ml-auto h-7 w-[100px] rounded-lg bg-D2_Gray" />
                  </div>
                ))}
            </div>
          </div>
          ...
          <div className="h-fit rounded-xl bg-D1_Gray Laptop:min-w-[360px] Laptop:p-10 Desktop:min-w-[492px] Desktop:px-[60px] Desktop:pb-[93px] Desktop:pt-[60px]">
            <div className="flex h-[200px] flex-col items-center justify-center">
              <div className="flex Laptop:gap-2 Desktop:gap-3">
                <div className="rounded-lg bg-D2_Gray Laptop:h-[32px] Laptop:w-20 Desktop:h-10 Desktop:w-[100px]" />
                <div className="rounded-lg bg-D2_Gray Laptop:h-[32px] Laptop:w-20 Desktop:h-10 Desktop:w-[100px]" />
                <div className="rounded-lg bg-D2_Gray Laptop:h-[32px] Laptop:w-20 Desktop:h-10 Desktop:w-[100px]" />
              </div>
            ...
            <div className="h-[45px] w-full rounded-xl bg-D2_Gray Laptop:mt-5 Desktop:mt-3" />
          </div>
        </div>
      </div>
    </div>
